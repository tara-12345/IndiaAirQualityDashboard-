...
1. open and download air_quality_full.db and app.py from this public sharepoint link:
...
python transform.py --database_path app/air_quality_full.db --query_directory sql/transforms  
